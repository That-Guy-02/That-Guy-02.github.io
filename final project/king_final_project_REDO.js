...
}).prototype = getMCSymbolPrototype(lib.portal, new cjs.Rectangle(-114,-227.9,233,433.9), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.portal();
	this.instance.setTransform(5389.3,-563.6,1,1,0,0,0,2.5,-11);

	this.instance_1 = new lib.pitchfork();
	this.instance_1.setTransform(3084.75,-564.1);

	this.instance_2 = new lib.halo();
	this.instance_2.setTransform(940.25,-560.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.eyeball_mc).wait(1));

	// background
	this.instance = new lib.background();
	this.instance.setTransform(2880,540,1,1,0,0,0,2880,-540);
...
p.nominalBounds = new cjs.Rectangle(959.5,539.5,4801,541);
// library properties:
lib.properties = {
