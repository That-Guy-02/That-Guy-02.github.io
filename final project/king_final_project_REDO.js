...
}).prototype = getMCSymbolPrototype(lib.portal_1, new cjs.Rectangle(-114,-227.9,233,433.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.portal_mc.setTransform(5473.3,-563.6,1,1,0,0,0,2.5,-11);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(1507.1,540);

	this.instance_2 = new lib.play_btn();
	this.instance_2.setTransform(412.9,540);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1}]}).to({state:[]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_1.png?1714953718497", id:"CachedBmp_1"},
		{src:"sounds/music.mp3?1714953718497", id:"music"},
		{src:"sounds/portal.mp3?1714953718497", id:"portal"},
		{src:"sounds/shatter.mp3?1714953718497", id:"shatter"},
		{src:"sounds/shing.mp3?1714953718497", id:"shing"}
	],
	preloads: []
};
